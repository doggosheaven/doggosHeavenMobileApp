...
/**
 * Shared by /staff/attendance and /admin/attendance, which were byte-identical
 * apart from the header treatment below.
 */
export default function AttendanceScreen({ backIcon = "arrow-back", showCount = true }) {
  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.header}>
        ...
        <Text style={[s.headerTitle, !showCount && s.headerTitleCentered]}>Attendance</Text>
        {showCount ? <Text style={s.headerSub}>{list.length} scheduled</Text> : <View style={{ width: 36 }} />}
      </View>
