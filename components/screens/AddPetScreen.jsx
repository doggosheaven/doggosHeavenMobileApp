...
/**
 * Shared by /staff/addpet and /admin/addpet. The staff copy had drifted ahead —
 * image MIME detection, the auto-formatting date field and a keyboard-aware
 * breed picker — so it is the one kept; admin picks those up.
 */
export default function AddPetScreen({ backIcon = "arrow-back", centerTitle = false }) {
  ...
  return (
    <KeyboardAvoidingView style={s.container} behavior={Platform.OS === "ios" ? "padding" : "height"}>
      <View style={[s.header, centerTitle && s.headerCentered]}>
        <TouchableOpacity onPress={() => router.back()} style={s.backBtn}>
          <Ionicons name={backIcon} size={22} color="#fff" />
        </TouchableOpacity>
        <Text style={[s.headerTitle, centerTitle && s.headerTitleCentered]}>Add Pet &amp; Owner</Text>
        <View style={{ width: 36 }} />
      </View>
...
const s = StyleSheet.create({
  ...
  headerCentered: { justifyContent: "flex-start" },
