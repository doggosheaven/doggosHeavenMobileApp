...
/**
 * Shared by /staff/blacklisted and /admin/blacklisted. Only an admin may lift a
 * blacklist; staff see the same list with the reason why they cannot.
 */
export default function BlacklistedScreen({ canRemove = false }) {
